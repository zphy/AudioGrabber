 ...
 #               return False
        ...
        for line in visible_texts:
            ...
            if visible_texts[i]=='Article metrics':
                print('1')
                flagstart=i
            if visible_texts[i]=='Subject terms:':
                print('1')
                flagstart=i
            if visible_texts[i]=='Digg':
                print('1')
                flagstart=i
            if visible_texts[i]=='Rights & Permissions':
                print('1')
                flagstart=i
